...
with st.form("health_form"):
    HighBP = st.selectbox('High Blood Pressure: Adults who have been told they have high blood pressure by a doctor, nurse, or other health professional', [0, 1], index=example_input['HighBP'])
